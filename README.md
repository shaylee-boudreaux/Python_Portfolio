...
```python
# Sometimes we want to look at variation in statistical values, such as maximum inflammation er patient, # or average from day one.
...
def offest_mean(data, target_mean_value):
    return (data - numpy.mean(data)) + target_mean_value
```
...
```
    ...
    <ipython-input-1-0cb5b428bf56> in <module>
          2 total = 0.0
...
def normalize_rectangle(rect):
    ...
    (x0, y0) and (x1, y1) define the lower left and upper right coners of the rectangle respectively."""
...
```
    ...
    <ipython-input-1-21e97574bfab> in <module>
         10     print(ice_creams[3])
         11 
    ---> 12 favorite_ice_cream()
    

    <ipython-input-1-21e97574bfab> in favorite_ice_cream()
          8         'strawberry'
          9     ]
    ---> 10     print(ice_creams[3])
         11 
...
```
    ...
    <ipython-input-13-080b0e91cc46> in <module>
...
In this anaylsis, we review using Python to transcribe DNA.
...
In this analysis, we review using Python to translate RNA.
...
```
    ...
    <ipython-input-1-2cb6e49a44dc> in <module>
    ----> 1 print(protein_sequence)
    

    NameError: name 'protein_sequence' is not defined
